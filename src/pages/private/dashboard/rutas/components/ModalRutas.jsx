...
export const ModalRutas = ({ visible, onClose, data = {}, setActualizar}) => {
    ...
    const onSubmit = async (data) => {
        console.log(data)
        try{
            const response = await postRutasData(data);
    ...
    return (
        <>
            ...
            <ModalComponent titulo="Crear Ruta" visibleModal={visible} onClose={onClose}>

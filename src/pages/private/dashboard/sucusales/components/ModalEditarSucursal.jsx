...
import { putSucursalesData } from '../../../../../services/sucuralService';

export const ModalEditarSucursal = ({ visible, onClose, data = {}, setActualizar}) => {
    ...
    const onSubmit = async (dataForm) => {
        try{
            const response = await putSucursalesData(data.sucursalId, dataForm);

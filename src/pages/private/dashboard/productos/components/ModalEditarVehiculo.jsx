...
import { putVehiculoData } from '../../../../../services/productoService';


export const ModalEditarVehiculo = ({ visible, onClose, data = {}, setActualizar}) => {
    ...
    const onSubmit = async (dataForm) => {
        try{
            const response = await putVehiculoData(data.vehiculoId, dataForm);
            setSuccessModalMessage('vehiculo editado correctamente');

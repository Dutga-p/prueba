...
import { getCategoriasData, putRepuestoData } from '../../../../../services/productoService';


export const ModalEditarRepuesto = ({ visible, onClose, data = {}, setActualizar}) => {
    ...
    const onSubmit = async (dataForm) => {
        try{
            const response = await putRepuestoData(data.repuestoId, dataForm);
            setSuccessModalMessage('repuesto editado correctamente');
    ...
    return (
        <>
            ...
            <ModalComponent titulo="Editar Repuesto" visibleModal={visible} onClose={onClose}>

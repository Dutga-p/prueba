...
export const ModalEditarUsuario = ({ visible, onClose, data = {} }) => {
    const { register, handleSubmit, formState: { errors }, reset } = useForm(
        {
            defaultValues: {
                ...
                rol: data?.rol !== undefined ? data.rol.toString() : '',
            }
        }
    );
    ...
    const onSubmit = async (dataForm) => {
        ...
        console.log(data)
        try{
            const response = await putUserData(data.idUsuario, dataForm);
            setSuccessModalMessage('Usuario editado con éxito');
    ...
    return (
        <>
            ...
            <ModalComponent titulo="Editar Usuario"  visibleModal={visible} onClose={onClose}>
